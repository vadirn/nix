...
description: >
  ...
  Produces checkpoint-{step}-{seq}-{timestamp}.md with YAML frontmatter
...
```
checkpoint_file = from prompt (e.g. ".nightshift/checkpoint-implement-003-2026-03-24-11-45-58.md")
