...
Apply all rules in a single pass. Rule details are in the reference files below. Apply only rules that improve the text.
...
| Sentences  | [pass-2-sentences.md](pass-2-sentences.md)   | Actor as subject, active voice, verb placement, familiar→new order, split+reconnect loop                 |
