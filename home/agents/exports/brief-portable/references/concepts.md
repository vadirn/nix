...
This is the working vocabulary the two procedures rely on. Self-contained — read it once per
session if the impression/target/axis terms are not already loaded.
