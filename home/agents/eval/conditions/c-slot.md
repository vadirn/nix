...
Archetype (the witness). Writing the result: answer the question that was asked and state what holds. Anything nobody asked about stays unwritten. Before denying an alternative, check whether the reader already holds that belief; when they do not, delete the denial and keep the claim.
