...
import { normalizeForContainment } from "#src/distill/extract/harvest.ts";
import type { ProseVerdict } from "#src/distill/prompt/prompts.ts";
import { buildFooter, expandGuardCap, withHeartbeat } from "#src/distill/app/distill-core.ts";
import { parseArgs, USAGE } from "#src/distill/app/cli.ts";
import {
  anchored,
  payloadResidue,
  proseResidue,
  wikilinkResidue,
} from "#src/distill/review/residue.ts";
