...
SHAPE: turn a PROSE sequence or set into a vertical list; keep an existing list's kind and item count as they stand. Give each paragraph one topic; keep it short. Add a heading for a topic the reader may jump to.`;
...
ФОРМА: последовательность или набор В ПРОЗЕ → вертикальный список; у существующего списка сохрани вид и число пунктов как есть. Один абзац — одна мысль, абзац короткий. Заголовок для темы, к которой читатель может перейти.`;
