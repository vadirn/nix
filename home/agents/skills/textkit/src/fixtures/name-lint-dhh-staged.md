...
- Source: [[We're moving continuous integration back to developer machines]] · archive c22c91afaff5
- Distill: 530→428 words (-19%) · 5 glossary entries · 4 workflow steps · 1 kept-verbatim · 2 retries
- Flags (residue, 8 entries):
  - citation-url dropped: [bridges of complexity](https://world.hey.com/dhh/introducing-propshaft-ee60f4f6) (propshaft post)
  - citation-url dropped: [RSS feed](https://world.hey.com/dhh/feed.atom)
  - numeric tokens dropped: 29, 16, 55,000 (lines of Ruby), 5,000 (test cases), 300 (system tests), 99.99% (share of web apps closer to HEY than to Shopify/GitHub)

## On commit

- [ ] Body reviewed — prose, Workflow, Glossary read correctly against the archive
