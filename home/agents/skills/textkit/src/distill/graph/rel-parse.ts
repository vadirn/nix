...
import { REL_ARROW, REL_DASH, TRAILING_ANCHOR_RE } from "textkit/distill/graph/graph.ts";
import { fenceScan, type FenceState, slugSegment, stripFences } from "textkit/core/text.ts";
