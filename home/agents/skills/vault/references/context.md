...
- **Checkpoint**: `type: checkpoint`, `description`, `done`, `project`, `decisions`, `frictions` (legacy)
- **Track**: `type: track`, `slug`, `description`, `status` (open/paused/done/abandoned/superseded), `project`, `created`, `updated`
