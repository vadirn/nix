...
import { computeSource, type Edge, type PreGraph, type Unit } from "@/graph/graph.ts";
import { locate } from "@/extract/locate.ts";
import type { Span } from "@/kernel/mdstruct.ts";
import { slugSegment, type Block } from "@/kernel/text.ts";
