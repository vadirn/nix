...
import { parseDoc, sliceBytes, walkHeadings, type Heading } from "@/kernel/mdstruct.ts";
import { DISPLAY_MATH_PATTERNS, structuralSpans } from "@/extract/harvest.ts";
import { wordCount } from "@/kernel/text.ts";
