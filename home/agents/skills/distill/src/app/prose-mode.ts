...
import { detectLang, glossList, langRule, segment, wordCount } from "@/kernel/text.ts";
...
import { PASS_EN, PASS_RU, revise } from "@/prompt/prompts.ts";
import { parseCanonicalNote, splitSections } from "@/graph/parse-projection.ts";
import { unwrapResult } from "@/app/envelope.ts";
