...
// The deterministic loss-surface primitives (wikilinkResidue, payloadResidue,
// edgePayloadResidue, and the proseResidue/anchored verdict mapping) live in residue.ts;
// pipeline.ts imports them and wires the LLM matcher below.
