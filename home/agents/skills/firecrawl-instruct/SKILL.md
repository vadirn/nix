...
description: |
  Live-browser interaction (click, fill, log in) on a scraped page via Firecrawl. Routed to from /firecrawl.
allowed-tools:
  - Bash(firecrawl *)
  - Bash(npx firecrawl *)
---
...
- Omit `--scrape-id` for subsequent interact calls; it resolves automatically.
